...
* When clipping by the entire 8-state area we get tons of prairie types that would be mostly absent if I had clipped to GLRI boundary, or totally missing if I had filtered for only "Forest" types.
...
bpsChart <- 
  ...
  labs(
    title = "Top 13 Biophysical Settings",
...
ggsave("./OUTPUTS/bpsChart.png", width = 12, height = 9)
```
